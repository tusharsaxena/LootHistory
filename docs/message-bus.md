...
- **Browser** (`modules/Browser.lua:1219`) calls `OnSettingsChanged()` to reflect the change in the open window.
...
- Browser — `B.__ev = NS.NewBusTarget()` (`modules/Browser.lua:1218`).
