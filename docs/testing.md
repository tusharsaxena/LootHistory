...
Twenty-two files, loaded in this order (see **[test-cases.md](test-cases.md)** for the full per-case
...
Four of the twenty-two exist because of the LibKa0s adoption:
