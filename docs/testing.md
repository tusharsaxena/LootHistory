...
Thirty-one files (see **[test-cases.md](test-cases.md)** for the full per-case inventory and the
...
Twelve of the thirty-one exist because of the LibKa0s adoption:
