# Agent Context — Ka0s Loot History

The full agent brief for this repo (the root `CLAUDE.md` is a stub that points here). Read this
first, then `TECHNICAL_DESIGN.md` for depth.
