...
`O.SetRenderer` (`settings/Panel.lua:1027`), and what survives the R6 revamp is narrower than the
...
the ~1.7s tab-transition freeze back. The reasoning is at `settings/Panel.lua:669-678`.
