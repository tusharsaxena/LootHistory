...
- `history` is a **dense array** — `Database:Delete`/`PruneOld` rebuild-and-swap rather than leaving holes (`core/Database.lua:518`, `:400`). Each record's field shape is documented in [data-model.md](data-model.md).
