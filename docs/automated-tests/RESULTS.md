...
**714 cases** — 714 passed, 0 failed, 0 skipped. The generated inventory
[`20260908-181338/test-cases.md`](20260908-181338/test-cases.md) is the authority on which cases existed at this run;
`docs/test-cases.md` is that same list at HEAD.

Moved **644 → 714** since the previous run.
...
**0 warnings / 0 errors over 58 files** (`luacheck .`).
...
Current as of [`20260908-181338`](20260908-181338/) — **this run's measurement, not its diff.** Max CCN **15** across 1803
